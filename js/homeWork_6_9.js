...
//выдает массив имен с сортировкой по количеству друзей от объекта с меньшим количеством друзей - к большему.
const getNamesSortedByFriendsCount = array => [...array]
    .sort((a, b) => a.friends.length - b.friends.length)
    .map(({ name }) => name);

//выдает массив имен с сортировкой по количеству скилов от объекта с большим количеством друзей - к меньшему.

const getNamesSortedBySkillsCount = array => [...array]
